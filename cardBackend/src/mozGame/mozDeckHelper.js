...
class MozDeckLogic {
    ...
    prepareDeckForPlayer(playerId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const playerDeck = yield this.deckManager.getPlayerDecks(playerId);
    ...
    isCardEligibleForField(card, leader, area) {
        ...
        const allowedTypes = ((_a = leader.zoneCompatibility) === null || _a === void 0 ? void 0 : _a[area]) || [];
