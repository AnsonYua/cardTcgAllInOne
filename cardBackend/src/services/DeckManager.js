...
class DeckManager {
    ...
    initializeSync() {
        try {
            ...
            if (characterCards && characterCards.cards) {
                this.cards.cards = Object.assign(Object.assign({}, this.cards.cards), characterCards.cards);
            }
            if (leaderCards && leaderCards.leaders) {
                this.cards.cards = Object.assign(Object.assign({}, this.cards.cards), leaderCards.leaders);
            }
            if (utilityCards && utilityCards.cards) {
                this.cards.cards = Object.assign(Object.assign({}, this.cards.cards), utilityCards.cards);
            }
    ...
    saveDecks() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield fsPromises.writeFile(this.decksPath, JSON.stringify(dataToSave, null, 2));
    ...
    drawCards(playerId_1) {
        return __awaiter(this, arguments, void 0, function* (playerId, count = 1) {
            const playerData = yield this.getPlayerDecks(playerId);
    ...
    getInitializationStatus() {
        ...
        return {
            ...
            cardsCount: ((_a = this.cards) === null || _a === void 0 ? void 0 : _a.cards) ? Object.keys(this.cards.cards).length : 0,
