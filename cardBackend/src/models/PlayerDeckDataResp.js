...
exports.createPlayerDeckDataRespFromMozHelper = exports.createPlayerDeckDataRespFromJSON = exports.createPlayerDeckDataResp = exports.PlayerDeckDataResp = void 0;
 ...
 */
     ...
     */
    clone() {
        return new PlayerDeckDataResp(this.currentLeaderIdx, [...this.leader], [...this.hand], [...this.mainDeck], Object.assign({}, this.leaderMapping), Object.assign({}, this.cardMapping));
    }
    // ============ SERIALIZATION ============
    /**
